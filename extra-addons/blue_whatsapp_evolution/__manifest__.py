...
#############################################################################
{
    ...
    'depends': ['base', 'contacts', 'crm', 'bus', 'mail', 'account', 'sale', 'whatsapp'],
    'data': [
        'security/ir.model.access.csv',
        'views/res_partner_views.xml',
        'views/view_blue_whatsapp_account.xml',
        # 'views/company_whatsapp_integration_views.xml',  # temporarily disabled
        'views/users_whatsapp_integration_views.xml', 
        'wizard/whatsapp_send_message_views.xml',
        'views/crm_lead_views.xml',
        'views/account_move_views.xml',
        'views/sale_order_views.xml',
        'views/view_api_response_form.xml',
        # Vista heredada para añadir opción de Evolution API
        'views/whatsapp_template_views_inherit.xml',
    ],
